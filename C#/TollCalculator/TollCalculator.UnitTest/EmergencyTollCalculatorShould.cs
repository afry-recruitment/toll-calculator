...
{
    public class EmergencyTollCalculatorShould
    {
        private readonly EmergencyTollCalculator emergencyTollCalculator;

        public EmergencyTollCalculatorShould()
        {
            this.emergencyTollCalculator = new EmergencyTollCalculator(new Emergency());
        }
        ...
        public void CalculateOnWeekend()
        {
            ...
            var totalToll = this.emergencyTollCalculator.GetTollFee(dates, tollFees);
        ...
        public void CalculateOnNoDatesPassed()
        {
            ...
            var tollFees = TimeToTollFeePopulator.InitializeTollFees();
            Assert.Throws<ArgumentException>(() => this.emergencyTollCalculator.GetTollFee(null, tollFees));
        }
