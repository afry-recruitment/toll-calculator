...
{
    public class MilitaryTollCalculatorShould
    {
        private readonly MilitaryTollCalculator militaryTollCalculator;

        public MilitaryTollCalculatorShould()
        {
            this.militaryTollCalculator = new MilitaryTollCalculator(new Military());
        }
        ...
        public void CalculateOnWeekend()
        {
            ...
            var totalToll = this.militaryTollCalculator.GetTollFee(dates, tollFees);
        ...
        public void CalculateOnNoDatesPassed()
        {
            ...
            var tollFees = TimeToTollFeePopulator.InitializeTollFees();
            Assert.Throws<ArgumentException>(() => this.militaryTollCalculator.GetTollFee(null, tollFees));
        }
