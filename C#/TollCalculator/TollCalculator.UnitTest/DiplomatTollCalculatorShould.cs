...
{
    public class DiplomatTollCalculatorShould
    {
        private readonly DiplomatTollCalculator diplomatTollCalculator;

        public DiplomatTollCalculatorShould()
        {
            this.diplomatTollCalculator = new DiplomatTollCalculator(new Diplomat());
        }
        ...
        public void CalculateOnWeekend()
        {
            ...
            var totalToll = this.diplomatTollCalculator.GetTollFee(dates, tollFees);
        ...
        public void CalculateOnNoDatesPassed()
        {
            ...
            var tollFees = TimeToTollFeePopulator.InitializeTollFees();
            Assert.Throws<ArgumentException>(() => this.diplomatTollCalculator.GetTollFee(null, tollFees));
        }
