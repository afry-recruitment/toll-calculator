...
public class TollCalculatorServiceImplTest {
    ...
    @Test
    public void validInputTollEligible() throws ParseException {
        ...
        TollCalculatorResponse result = tollCalculatorService.getTollFeeAmount("Gothenburg", request.getVehicle(), request.getCheckInTime());
        assertThat(result).isNotNull();
        assertThat(result.getTollFeeAmount()).isEqualTo(new BigDecimal(8));
    }
    ...
    private Optional<City> validVehicleDetails() throws ParseException {
        ...
        Set<CityTollRate> tariffEntities = new HashSet<>();
        CityTollRate tariffEntity1 = CityTollRate.builder()
                .city(cityEntity)
        ...
        cityEntity.setCityTollRates(tariffEntities);

        CityTollChoice cityPreferenceEntity = CityTollChoice.builder()
                .maxTollPerDay(60)
                .numberOfTollFreeDaysBeforeHoliday(1)
                .singleChargeIntervalInMin(60)
                .build();
        cityEntity.setCityTollChoice(cityPreferenceEntity);
