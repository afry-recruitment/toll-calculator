...
CREATE TABLE city_toll_exempt_vehicle (
...
INSERT INTO city_toll_exempt_vehicle VALUES (1,1),(1,3),(1,4),(1,5),(1,6),(1,8);
...
CREATE TABLE city_toll_rate (
    ...
    city_id bigint NOT NULL,
    PRIMARY KEY (id),
    CONSTRAINT `FK_toll_rate` FOREIGN KEY (city_id) REFERENCES city (id)
);
INSERT INTO city_toll_rate VALUES (1,8.00,'06:00:00','06:29:59',1),(2,13.00,'06:30:00','06:59:59',1),(3,18.00,'07:00:00','07:59:59',1),
...
CREATE TABLE city_toll_choice (
    max_toll_per_day int NOT NULL DEFAULT '60',
    number_of_toll_free_days_before_holiday int NOT NULL DEFAULT '0',
    single_charge_interval_in_min int NOT NULL DEFAULT '0',
    city_id bigint NOT NULL,
    PRIMARY KEY (city_id),
    CONSTRAINT `FK_city_toll_choice` FOREIGN KEY (city_id) REFERENCES city (id)
);
INSERT INTO city_toll_choice VALUES (60,1,60,1);