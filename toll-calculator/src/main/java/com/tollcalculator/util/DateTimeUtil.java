...
public class DateTimeUtil {
    ...
    public static boolean getDateBeforeHolidayORPublicHoliday(Date date, City city){
        ...
        for(CityHolidayCalendar cityHolidayCalendar : cityPublicHoliday) {
            Integer numberOfTTollFreeDaysBeforeHoliday = city.getCityTollChoice().getNumberOfTollFreeDaysBeforeHoliday();
            Date min = DateUtils.addDays(cityHolidayCalendar.getDate(), numberOfTTollFreeDaysBeforeHoliday);
