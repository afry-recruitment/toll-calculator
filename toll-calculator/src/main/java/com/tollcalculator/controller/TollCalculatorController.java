 ...
 */
@RestController
@RequestMapping("/api/v1/toll-calculate")
public class TollCalculatorController {
    ...
    public ResponseEntity<TollCalculatorResponse> calculateToll(@RequestBody TollCalculatorRequest tollCalculatorRequest) throws InvalidParameterException {
        ...
        TollCalculatorResponse result = tollCalculatorService.getTollFeeAmount(tollCalculatorRequest.getCity(), tollCalculatorRequest.getVehicle(), tollCalculatorRequest.getCheckInTime());
