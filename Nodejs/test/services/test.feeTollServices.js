...
import { convertToTime, isBetweenIntervals, getPassingTime, getTollFee } from '../../services/feeTollServices.js';
...
describe('feeTollServices',()=>{
    ...
    describe('#getPassingTime()',()=>{
        ...
        it('with new Date(2013-01-05T10:02:00.000Z) argument',()=>{
            assert.deepEqual(getPassingTime(new Date('2013-01-05T10:02:00.000Z')),new Date('2013-01-05T10:02:00.000Z'))
        })
    });
