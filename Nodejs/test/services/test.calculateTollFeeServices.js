...
describe('calculateTollFeeServices', () => {
  describe('#calculateTollFee()', () => {
    ...
    it('with new Car(),date(2013-01-04T16:12:00) argument', () => {
      expect(
        calculateTollFee(new Car(), new Date('2013-01-04T16:12:00'))
      ).to.equal(8);
    });
    it('with new Car(),date(2013-01-04T17:19:00) argument', () => {
      expect(
        calculateTollFee(new Car(), new Date('2013-01-04T17:19:00'))
      ).to.equal(8);
    });
    it('with new Car(),date(2013-01-04T22:09:00) argument', () => {
      expect(
        calculateTollFee(new Car(), new Date('2013-01-04T22:09:00'))
      ).to.equal(0);
    });
    it('with new Car(),date(2013-01-04T09:09:00) argument', () => {
      expect(
        calculateTollFee(new Car(), new Date('2013-01-04T10:09:00'))
      ).to.equal(13);
    });
    it('with argument', () => {
      expect(
