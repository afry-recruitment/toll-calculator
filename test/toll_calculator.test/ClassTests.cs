...
public class ClassTests
{
    ...
    {
        TestCarToll(5, 59, 59, 999).Should().Be(0);
        TestCarToll(6, 0).Should().Be(TollFee.LowTraffic);
        TestCarToll(6, 29, 59, 999).Should().Be(TollFee.LowTraffic);
        TestCarToll(6, 30).Should().Be(TollFee.MidTraffic);
        TestCarToll(6, 59, 59, 999).Should().Be(TollFee.MidTraffic);
        TestCarToll(7, 0).Should().Be(TollFee.RushHourTraffic);
        TestCarToll(7, 59, 59, 999).Should().Be(TollFee.RushHourTraffic);
        TestCarToll(8, 0).Should().Be(TollFee.MidTraffic);
        TestCarToll(8, 29, 59, 999).Should().Be(TollFee.MidTraffic);
        TestCarToll(8, 30).Should().Be(TollFee.LowTraffic);
        TestCarToll(14, 59, 59, 999).Should().Be(TollFee.LowTraffic);
        TestCarToll(15, 00).Should().Be(TollFee.MidTraffic);
        TestCarToll(14, 59, 59, 999).Should().Be(TollFee.LowTraffic);
        TestCarToll(15, 0).Should().Be(TollFee.MidTraffic);
        TestCarToll(15, 29, 59, 999).Should().Be(TollFee.MidTraffic);
        TestCarToll(16, 0).Should().Be(TollFee.RushHourTraffic);
        TestCarToll(16, 59, 59, 999).Should().Be(TollFee.RushHourTraffic);
        TestCarToll(17, 00).Should().Be(TollFee.MidTraffic);
        TestCarToll(17, 59, 59, 999).Should().Be(TollFee.MidTraffic);
        TestCarToll(18, 00).Should().Be(TollFee.LowTraffic);
        TestCarToll(18, 29, 59, 999).Should().Be(TollFee.LowTraffic);
        TestCarToll(18, 30).Should().Be(0);
        TestCarToll(23, 59, 59, 999).Should().Be(0);
